...
const handleMouseMove = (e: MouseEvent) => {
    ...
    // 平滑过渡
    mouseX.value += (x - mouseX.value) * 0.1
    mouseY.value += (y - mouseY.value) * 0.1
}

const animate = () => {
    // 如需要可添加连续缓动效果，但主要通过 CSS 或直接样式绑定来处理
    ...
    <section id="hero" class="hero">
        ...
        <div class="hero-content container" :style="{ transform: `translate(${mouseX * -5}px, ${mouseY * -5}px)` }">
            ...
            <div class="hero-actions animate-on-scroll delay-3">
                <a href="#download" class="btn btn-primary btn-lg btn-glow" id="hero-download-btn">
...
.scroll-line::after {
    ...
    width: 100%;
    height: 50%;
    background: linear-gradient(to bottom, transparent, var(--color-accent-cyan), var(--color-accent-teal));

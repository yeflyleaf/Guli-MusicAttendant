...
<template>
  <section id="i18n" class="section i18n-section">
    ...
    <div class="container relative-z">
      ...
      <div class="lang-grid">
        <div v-for="(lang, index) in languages" :key="lang.code" class="lang-card" :class="[
          {
            'lang-card-active': selectedLang === index
          }
        ]" :id="'lang-card-' + lang.code" @mouseenter="hoveredLang = index" @mouseleave="hoveredLang = null"
          @click="selectLang(index)">
          <span class="lang-flag" :class="{ 'flag-bounce': hoveredLang === index }">{{
            lang.flag
          }}</span>
          <div class="lang-info">

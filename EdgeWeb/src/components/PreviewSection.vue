...
const highlightItems = [
    ...
    { icon: '🎤', title: '沉浸歌词', desc: 'LRC 歌词同步滚动，视觉化音乐享受', id: 'immersive-lyrics' },
    ...
    <section id="preview" class="section preview-section">
        ...
        <div class="container relative-z">
            <h2 class="section-title animate-on-scroll">
                应用<span class="gradient-text">预览</span>
            </h2>
            ...
            <div class="preview-showcase animate-on-scroll delay-2">
                <div class="preview-frame" ref="frameRef" @mousemove="handleFrameMouseMove"
                    @mouseleave="handleFrameMouseLeave" :style="{
                    ...
                    <div class="preview-image-wrapper">
                        <img src="/screenshot-home.png" alt="故里音乐助手主界面 - 展示主页、最近播放、播放控制栏" class="preview-image"
                            loading="lazy" />
                ...
                <!-- 边框周围的悬浮功能徽章 -->
                <div class="floating-badge badge-left animate-on-scroll delay-3">
                    <span class="badge-icon">🎵</span>
                    <span>无损音质</span>
                </div>
                <div class="floating-badge badge-right animate-on-scroll delay-4">
                    <span class="badge-icon">🌙</span>
                    <span>暗色主题</span>
                </div>
                <div class="floating-badge badge-bottom animate-on-scroll delay-5">
                    <span class="badge-icon">⚡</span>
                    <span>毫秒响应</span>
                </div>
            </div>
...
.preview-frame:hover {
    box-shadow: 0 40px 80px rgba(0, 0, 0, 0.6), 0 0 40px rgba(0, 229, 255, 0.1);
}

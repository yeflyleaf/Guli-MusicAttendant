...
.fractal-zoom-layer {
    ...
    &.active {
        ...
        .fractal-tunnel {
            animation: tunnelZoom 2s ease-in forwards;
        }

        .spectrum-burst {
            animation: spectrumBurst 0.5s ease-out 1.5s forwards;
        }

        .void-white {
            animation: voidExpand 0.5s ease-out 2s forwards;
        }
    }
}
...
.spectrum-burst {
    ...
    background: radial-gradient(circle at center,
            transparent 0%,
            rgba($holographic-cyan, 0) 40%,
            rgba($holographic-magenta, 0) 70%,
            rgba($holographic-yellow, 0) 100%);
    opacity: 0;
}
...
@keyframes spectrumBurst {
    0% {
        ...
        background: radial-gradient(circle at center,
                transparent 0%,
                rgba($holographic-cyan, 0) 20%,
                rgba($holographic-magenta, 0) 40%,
                transparent 60%);
    }
    ...
    50% {
        ...
        background: radial-gradient(circle at center,
                ...
                rgba($holographic-cyan, 0.6) 20%,
                rgba($holographic-magenta, 0.4) 40%,
                rgba($holographic-yellow, 0.2) 60%,
                transparent 80%);
    }

<template>
  <div class="interstellar-background" :class="{ embedded: embedded }" ref="containerRef" @mousemove="handleMouseMove">
    ...
    <div class="planets-layer" :style="parallaxStyle">
      ...
      <!-- 星云蓝星 - 顶部中央 -->
      <div class="planet nebula-blue-planet">
        <div class="planet-body"></div>
      ...
      <!-- 极光橙星 - 顶部中左 -->
      <div class="planet aurora-orange-planet">
        <div class="planet-body"></div>
        <div class="aurora-bands"></div>
        <div class="planet-glow"></div>
      </div>

      <!-- 翡翠环星 - 中间偏上左侧 (带三层星环) -->
      <div class="planet emerald-ringed-planet">
        <div class="planet-body"></div>
        <div class="planet-ring ring-outer"></div>
        <div class="planet-ring ring-middle"></div>
        <div class="planet-ring ring-inner"></div>
      ...
      <!-- 玫瑰金环星 - 中间偏上右侧 (带三层星环) -->
      <div class="planet rose-gold-ringed-planet">
        <div class="planet-body"></div>
        <div class="planet-ring ring-outer"></div>
        <div class="planet-ring ring-middle"></div>
        <div class="planet-ring ring-inner"></div>
...
.nebula-blue-planet {
  ...
  .nebula-swirl {
    ...
    border-radius: 50%;
    background:
      radial-gradient(ellipse at 30% 40%, rgba(147, 197, 253, 0.5) 0%, transparent 40%),
      radial-gradient(ellipse at 70% 60%, rgba(96, 165, 250, 0.4) 0%, transparent 35%),
      conic-gradient(from 0deg at 50% 50%,
        transparent 0deg,
        rgba(147, 197, 253, 0.3) 60deg,
        transparent 120deg,
        rgba(96, 165, 250, 0.2) 180deg,
        transparent 240deg,
        rgba(147, 197, 253, 0.25) 300deg,
        transparent 360deg);
    animation: nebulaSwirl 20s linear infinite;
  }
...
.aurora-orange-planet {
  ...
  .aurora-bands {
    ...
    &::before {
      ...
      background: linear-gradient(90deg,
          transparent 0%,
          rgba(254, 215, 170, 0.4) 20%,
          rgba(253, 186, 116, 0.5) 50%,
          rgba(254, 215, 170, 0.4) 80%,
          transparent 100%);
    ...
    &::after {
      ...
      animation: auroraPulse 3s ease-in-out infinite 0.5s;
    }
  }
...
.emerald-ringed-planet {
  ...
  .planet-body {
    ...
    box-shadow:
      ...
      inset 6px 6px 15px rgba(110, 231, 183, 0.3),
  ...
  .planet-ring {
    ...
    left: 50%;
    border-radius: 50%;
    animation: emeraldRingRotate 35s linear infinite;
    ...
    &.ring-middle {
      ...
      background: linear-gradient(90deg,
          transparent 0%,
          rgba(110, 231, 183, 0.15) 20%,
          rgba(52, 211, 153, 0.25) 50%,
          rgba(110, 231, 183, 0.15) 80%,
          transparent 100%);
      animation-duration: 30s;
      animation-direction: reverse;
    }
...
.rose-gold-ringed-planet {
  ...
  .planet-body {
    ...
    box-shadow:
      inset -10px -10px 25px rgba(0, 0, 0, 0.5),
      inset 5px 5px 12px rgba(254, 205, 211, 0.3),
  ...
  .planet-ring {
    ...
    left: 50%;
    border-radius: 50%;
    animation: roseRingRotate 32s linear infinite;
    ...
    &.ring-outer {
      ...
      background: linear-gradient(90deg,
          transparent 0%,
          rgba(254, 205, 211, 0.2) 15%,
          rgba(251, 113, 133, 0.3) 35%,
          rgba(254, 205, 211, 0.25) 50%,
          rgba(251, 113, 133, 0.3) 65%,
          rgba(254, 205, 211, 0.2) 85%,
          transparent 100%);
      box-shadow:
        0 0 15px rgba(251, 113, 133, 0.4),
        0 0 30px rgba(225, 29, 72, 0.25),
        inset 0 0 15px rgba(254, 205, 211, 0.2);
    }
    ...
    &.ring-middle {
      ...
      background: linear-gradient(90deg,
          transparent 0%,
          rgba(251, 113, 133, 0.15) 20%,
          rgba(254, 205, 211, 0.25) 50%,
          rgba(251, 113, 133, 0.15) 80%,
          transparent 100%);
  ...
  .ring-glow {
    ...
    background: radial-gradient(ellipse at center,
        ...
        transparent 70%);
    filter: blur(10px);
    animation: ringGlow 4.5s ease-in-out infinite 0.5s;
  }
  ...
  .planet-glow {
    ...
    background: radial-gradient(circle at center,
        ...
        rgba(251, 113, 133, 0.2) 40%,
        transparent 70%);
  }
}

@keyframes roseRingRotate {
  from {
    transform: translate(-50%, -50%) rotateX(70deg) rotateZ(15deg);
  }

  to {
    transform: translate(-50%, -50%) rotateX(70deg) rotateZ(375deg);
  }
}
</style>

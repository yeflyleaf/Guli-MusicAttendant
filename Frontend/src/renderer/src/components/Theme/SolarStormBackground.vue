  ...
  <div class="solar-storm-background" :class="{ embedded: embedded }" ref="containerRef" @mousemove="handleMouseMove">
    ...
    <div class="magnetic-arcs-layer" :style="parallaxStyle">
      <svg class="arcs-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
        <defs>
          <!-- 日珥拱门渐变 -->
          <linearGradient id="solar-arc-gradient-1" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <linearGradient id="solar-arc-gradient-2" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stop-color="transparent" />
          ...
          <linearGradient id="solar-arc-gradient-3" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stop-color="transparent" />
          ...
          <!-- 发光滤镜 -->
          <filter id="solar-arc-glow" x="-50%" y="-50%" width="200%" height="200%">
        ...
        <!-- 日珥拱门路径 -->
        <path class="prominence-arc arc-1" d="M -5 95 Q 25 30, 55 95" fill="none" stroke="url(#solar-arc-gradient-1)"
          stroke-width="0.8" filter="url(#solar-arc-glow)" />
        <path class="prominence-arc arc-2" d="M 35 95 Q 60 45, 85 95" fill="none" stroke="url(#solar-arc-gradient-2)"
          stroke-width="0.6" filter="url(#solar-arc-glow)" />
        <path class="prominence-arc arc-3" d="M 70 95 Q 90 55, 110 95" fill="none" stroke="url(#solar-arc-gradient-3)"
          stroke-width="0.5" filter="url(#solar-arc-glow)" />
      </svg>
    </div>
...
onMounted(() => {
  console.log('[SolarStormBackground] Component mounted!')
  initGranulation()
  initSolarWind()
})

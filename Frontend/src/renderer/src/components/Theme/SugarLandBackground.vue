<template>
  <div class="sugarland-background" :class="{ embedded: embedded }" ref="containerRef">
    ...
    <div class="candies-layer" :style="parallaxStyle">
      ...
      <!-- 迷你甜甜圈 - 10个小甜甜圈分布于空白区域 -->
      <div class="candy mini-donut mini-donut-1"></div>
      <div class="candy mini-donut mini-donut-2"></div>
      <div class="candy mini-donut mini-donut-3"></div>
      <div class="candy mini-donut mini-donut-4"></div>
      <div class="candy mini-donut mini-donut-5"></div>
      <div class="candy mini-donut mini-donut-6"></div>
      <div class="candy mini-donut mini-donut-7"></div>
      <div class="candy mini-donut mini-donut-8"></div>
      <div class="candy mini-donut mini-donut-9"></div>
      <div class="candy mini-donut mini-donut-10"></div>
    </div>
...
.mini-donut {
  ...
  &::before {
    ...
    transform: translate(-50%, -50%);
    border-radius: 50%;
    background: linear-gradient(180deg, #fff0f5 0%, #ffe6fa 100%);
  ...
  &.mini-donut-1 {
    top: 22%;
    left: 42%;
    background: radial-gradient(circle at 40% 40%, #ffd1dc, #ff69b4);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(255, 105, 180, 0.2);
    animation-delay: 0s;
  }
  ...
  &.mini-donut-2 {
    top: 28%;
    right: 18%;
    background: radial-gradient(circle at 40% 40%, #b8f5b8, #66cd66);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(102, 205, 102, 0.2);
    animation-delay: -1s;
  ...
  &.mini-donut-3 {
    top: 55%;
    left: 15%;
    background: radial-gradient(circle at 40% 40%, #b0e0e6, #00bfff);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(0, 191, 255, 0.2);
    animation-delay: -2s;
    transform: scale(0.9);
  }
  ...
  &.mini-donut-4 {
    bottom: 30%;
    left: 48%;
    background: radial-gradient(circle at 40% 40%, #fff8b0, #daa520);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(218, 165, 32, 0.2);
    animation-delay: -3s;
    transform: scale(0.8);
  }
  ...
  &.mini-donut-5 {
    bottom: 35%;
    right: 20%;
    background: radial-gradient(circle at 40% 40%, #dda0dd, #9932cc);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(153, 50, 204, 0.2);
    animation-delay: -4s;
  ...
  &.mini-donut-6 {
    top: 18%;
    left: 12%;
    background: radial-gradient(circle at 40% 40%, #ffd1dc, #ff1493);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(255, 20, 147, 0.2);
    animation-delay: -5s;
    transform: scale(0.7);
  }
  ...
  &.mini-donut-7 {
    top: 38%;
    left: 55%;
    background: radial-gradient(circle at 40% 40%, #98ff98, #32cd32);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(50, 205, 50, 0.2);
    animation-delay: -6s;
  ...
  &.mini-donut-8 {
    top: 15%;
    right: 30%;
    background: radial-gradient(circle at 40% 40%, #87ceeb, #4169e1);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(65, 105, 225, 0.2);
    animation-delay: -7s;
    transform: scale(0.8);
  }
  ...
  &.mini-donut-9 {
    bottom: 25%;
    left: 22%;
    background: radial-gradient(circle at 40% 40%, #ffcc99, #ff8c00);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(255, 140, 0, 0.2);
    animation-delay: -8s;
    transform: scale(0.75);
  }
  ...
  &.mini-donut-10 {
    top: 60%;
    right: 12%;
    background: radial-gradient(circle at 40% 40%, #e6e6fa, #8a2be2);
    box-shadow: inset -3px -3px 10px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(138, 43, 226, 0.2);
    animation-delay: -0.5s;
    transform: scale(0.7);
  }
}

@keyframes miniDonutFloat {
